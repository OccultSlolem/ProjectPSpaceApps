export type Planet = 
    ...
    'Dione' | 'Enceladus' | 'Mimas' | 'Phoebe' | 'Rhea' | 'Tethys' |
    'Iapetus' 
;
...
export const PLANET_MAP_URLS: Map<Planet, string> = new Map([
    ...
    ['Dione', 'https://trek.nasa.gov/tiles/Dione/EQ/Dione_Cassini_Voyageglobal_154m/1.0.0//default/default028mm/{TileMatrix}/{TileRow}/{TileCol}.jpg'],
...
export const PLANET_MAP_LAYERS: Map<Planet, string> = new Map([
  ...
  ['Dione', 'Dione_Cassini_Voyageglobal_154m'], 
